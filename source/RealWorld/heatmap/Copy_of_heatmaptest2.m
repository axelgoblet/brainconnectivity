...
causality = load('..\..\..\output\trialshuffle\FaescausalityResultsV1toV1.mat');
causality11 = causality.data;
significance = load('..\..\..\output\trialshuffle\FaessignificanceResultsV1toV1.mat');
significance11 = significance.data;
causality = load('..\..\..\output\trialshuffle\FaescausalityResultsV1toV4.mat')
causality12 = causality.data;
significance = load('..\..\..\output\trialshuffle\FaessignificanceResultsV1toV4.mat');
significance12 = significance.data;
causality = load('..\..\..\output\trialshuffle\FaescausalityResultsV4toV1.mat')
causality111 = causality.data;
significance = load('..\..\..\output\trialshuffle\FaessignificanceResultsV4toV1.mat');
significance111 = significance.data;
causality = load('..\..\..\output\trialshuffle\FaescausalityResultsV4toV4.mat')
causality1111 = causality.data;
significance = load('..\..\..\output\trialshuffle\FaessignificanceResultsV4toV4.mat');
