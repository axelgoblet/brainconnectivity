...
for realization=1:50
    ...
    x1tox2=x1tox2 + 1/50 * CNPMR(x2,x1,x3,1,3,1,1,1);
    x1tox3=x1tox3 + 1/50 * CNPMR(x3,x1,x2,1,3,1,1,1);
    x2tox1=x2tox1 + 1/50 * CNPMR(x1,x2,x3,1,3,1,1,1);
    x2tox3=x2tox3 + 1/50 * CNPMR(x3,x2,x1,1,3,1,1,1);
    x3tox1=x3tox1 + 1/50 * CNPMR(x1,x3,x2,1,3,1,1,1);
    x3tox2=x3tox2 + 1/50 * CNPMR(x2,x3,x1,1,3,1,1,1);    
end

% output
x1tox2 %the paper states 0.510
x1tox3 %the paper states -0.125
x2tox1 %the paper states -0.003
x2tox3 %the paper states 0.064
